...
namespace LuisBot.Dialogs
{
    public class ConversationStarter
    {
        ...
        public static async Task Resume(string conversationId, string channelId,string aeRequestId)
        {
            GetStatus getStatus = new GetStatus();

            string response = getStatus.GetStatusAECall(aeRequestId); //Get Status Response(response from ae) // Error or message get from ae aeRequestId

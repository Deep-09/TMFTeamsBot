...
namespace LuisBot.Dialogs
{
    public class CreateJSON
    {
        ...
        {
            var client = new RestClient("https://e29b24de.ngrok.io/aeengine/rest/authenticate"); //ae authentication
            ...
            var request1 = new RestRequest("https://e29b24de.ngrok.io/aeengine/rest/execute", Method.POST); //workflow execution

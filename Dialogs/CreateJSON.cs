...
namespace LuisBot.Dialogs
{
    public class CreateJSON
    {
        ...
        {
            var client = new RestClient("https://232bd378.ngrok.io/aeengine/rest/authenticate"); //ae authentication
            ...
            var request1 = new RestRequest("https://232bd378.ngrok.io/aeengine/rest/execute", Method.POST); //workflow execution

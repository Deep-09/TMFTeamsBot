...
namespace LuisBot.Dialogs
{
    public class CreateJSON
    {
        ...
        {
            var client = new RestClient("http://10.51.28.19:8080/aeengine/rest/authenticate"); //ae authentication
            ...
            var request1 = new RestRequest("http://10.51.28.19:8080/aeengine/rest/execute", Method.POST); //workflow execution
